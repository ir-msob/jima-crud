...
import ir.msob.jima.crud.kafka.reactive.test.resource.domain.base.DomainCrudKafkaResourceTest;
...
@Testcontainers
@CommonsLog
class TestDomainKafkaResourceIT extends DomainCrudKafkaResourceTest<TestDomain, TestDto, TestCriteria, TestRepository, TestDomainService, TestDataProvider> {
