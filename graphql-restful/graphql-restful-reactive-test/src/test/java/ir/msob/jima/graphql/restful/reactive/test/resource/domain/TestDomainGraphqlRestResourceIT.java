...
import ir.msob.jima.graphql.restful.reactive.test.resource.domain.base.DomainCrudGraphqlRestResourceTest;
...
@Testcontainers
@CommonsLog
class TestDomainGraphqlRestResourceIT extends DomainCrudGraphqlRestResourceTest<TestDomain, TestDto, TestCriteria, TestRepository, TestDomainService, TestDataProvider> {
