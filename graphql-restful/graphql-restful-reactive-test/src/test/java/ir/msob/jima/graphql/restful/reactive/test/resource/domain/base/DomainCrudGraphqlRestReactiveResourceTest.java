...
import ir.msob.jima.graphql.restful.reactive.test.domain.BaseDomainCrudGraphqlRestReactiveResourceTest;
...
public abstract class DomainCrudGraphqlRestReactiveResourceTest<
        ...
        implements BaseDomainCrudGraphqlRestReactiveResourceTest<String, ProjectUser, D, DTO, C, R, S, DP> {
