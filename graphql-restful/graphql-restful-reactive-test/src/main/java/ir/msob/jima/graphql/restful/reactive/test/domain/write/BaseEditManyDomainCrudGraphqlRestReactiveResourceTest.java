...
/**
 * The {@code BaseEditManyDomainCrudGraphqlRestReactiveResourceTest} interface represents a set of GraphQL-specific test methods
 * for editing (updating) multiple entities based on criteria using JSON Patch operations. It extends both the
 * {@code BaseEditManyChildDomainCrudReactiveResourceTest} and {@code ParentDomainCrudGraphqlRestResourceTest} interfaces, providing GraphQL-specific
 ...
 * @see ParentDomainCrudGraphqlRestResourceTest
 */
public interface BaseEditManyDomainCrudGraphqlRestReactiveResourceTest<
