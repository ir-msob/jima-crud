...
/**
 * The {@code BaseDeleteManyDomainCrudGraphqlRestReactiveResourceTest} interface represents a set of GraphQL-specific test methods
 * for deleting multiple entities based on criteria in the context of CRUD operations. It extends both the
 * {@code BaseDeleteManyChildDomainCrudReactiveResourceTest} and {@code ParentDomainCrudGraphqlRestResourceTest} interfaces, providing GraphQL-specific
 ...
 * @see ParentDomainCrudGraphqlRestResourceTest
 */
public interface BaseDeleteManyDomainCrudGraphqlRestReactiveResourceTest<
