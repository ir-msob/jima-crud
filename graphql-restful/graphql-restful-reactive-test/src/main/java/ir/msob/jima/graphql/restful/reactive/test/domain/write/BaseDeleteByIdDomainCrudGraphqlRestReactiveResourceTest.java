...
/**
 * The {@code BaseDeleteDomainCrudGraphqlRestReactiveResourceTest} interface represents a set of GraphQL-specific test methods
 * for deleting an entity based on criteria in the context of CRUD operations. It extends both the
 * {@code BaseDeleteChildDomainCrudReactiveResourceTest} and {@code ParentDomainCrudGraphqlRestResourceTest} interfaces, providing GraphQL-specific
 ...
 * @see ParentDomainCrudGraphqlRestResourceTest
 */
public interface BaseDeleteByIdDomainCrudGraphqlRestReactiveResourceTest<
