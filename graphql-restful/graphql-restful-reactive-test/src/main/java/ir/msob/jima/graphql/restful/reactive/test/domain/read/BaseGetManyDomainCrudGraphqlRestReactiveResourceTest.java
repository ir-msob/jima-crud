...
/**
 * The {@code BaseGetManyDomainCrudGraphqlRestReactiveResourceTest} interface represents a set of GraphQL-specific test methods
 * for retrieving multiple entities based on criteria in the context of CRUD operations. It extends both the
 * {@code BaseGetManyChildDomainCrudReactiveResourceTest} and {@code ParentDomainCrudGraphqlRestResourceTest} interfaces, providing GraphQL-specific
 ...
 * @see ParentDomainCrudGraphqlRestResourceTest
 */
public interface BaseGetManyDomainCrudGraphqlRestReactiveResourceTest<
