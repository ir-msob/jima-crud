...
public abstract class R2dbcDomainCrudRepository<D extends ProjectDomain, C extends ProjectCriteria>
        implements BaseDomainCrudR2dbcRepository<String, D, C>
        , BaseR2dbcRepository<String, D, C> {
