...
import ir.msob.jima.crud.reactive.test.resource.childdomain.write.BaseDeleteByIdChildDomainCrudReactiveResourceTest;
...
/**
 * The {@code BaseDeleteByIdChildDomainCrudRestReactiveResourceTest} interface represents a set of RESTful-specific test methods for deleting an entity by its ID.
 * It extends both the {@code BaseDeleteByIdChildDomainCrudReactiveResourceTest} and {@code BaseEmbeddedDomainCrudRestReactiveResourceTest} interfaces, providing RESTful-specific testing capabilities.
 * <p>
 ...
 */
public interface BaseDeleteByIdChildDomainCrudRestReactiveResourceTest<
        ...
        extends BaseDeleteByIdChildDomainCrudReactiveResourceTest<ID, USER, D, DTO, C, R, S, DP>,
     ...
     */
    @Override
    default void deleteByIdRequest(ID parentId, DTO savedDto, Assertable<ID> assertable) throws DomainNotFoundException, BadRequestException {
