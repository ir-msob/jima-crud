...
import ir.msob.jima.crud.reactive.test.resource.childdomain.write.BaseUpdateByIdChildDomainCrudReactiveResourceTest;
...
/**
 * The {@code BaseUpdateByIdChildDomainCrudRestReactiveResourceTest} interface represents a set of RESTful-specific test methods for updating an entity by its ID.
 * It extends both the {@code BaseUpdateByIdChildDomainCrudReactiveResourceTest} and {@code BaseEmbeddedDomainCrudRestReactiveResourceTest} interfaces, providing RESTful-specific testing capabilities.
 * <p>
 ...
 */
public interface BaseUpdateByIdChildDomainCrudRestReactiveResourceTest<
        ...
        extends BaseUpdateByIdChildDomainCrudReactiveResourceTest<ID, USER, D, DTO, C, R, S, DP>,
