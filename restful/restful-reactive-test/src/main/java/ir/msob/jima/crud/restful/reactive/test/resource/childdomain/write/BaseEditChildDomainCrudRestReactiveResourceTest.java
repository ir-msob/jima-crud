...
import ir.msob.jima.crud.reactive.test.resource.childdomain.write.BaseEditChildDomainCrudReactiveResourceTest;
import ir.msob.jima.crud.reactive.test.resource.domain.write.BaseEditDomainCrudReactiveResourceTest;
...
/**
 * The {@code BaseEditChildDomainCrudRestReactiveResourceTest} interface represents a set of RESTful-specific test methods for editing an entity.
 * It extends both the {@code BaseEditChildDomainCrudReactiveResourceTest} and {@code BaseEmbeddedDomainCrudRestReactiveResourceTest} interfaces, providing RESTful-specific testing capabilities.
 * <p>
 ...
 * @see BaseEditDomainCrudReactiveResourceTest
 * @see ParentChildDomainCrudRestResourceTest
 */
public interface BaseEditChildDomainCrudRestReactiveResourceTest<
        ...
        extends BaseEditChildDomainCrudReactiveResourceTest<ID, USER, D, DTO, C, R, S, DP>,
