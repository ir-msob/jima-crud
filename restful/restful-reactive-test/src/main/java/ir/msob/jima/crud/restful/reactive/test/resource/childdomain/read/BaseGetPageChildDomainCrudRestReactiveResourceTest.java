...
import ir.msob.jima.crud.reactive.test.resource.childdomain.read.BaseGetPageChildDomainCrudReactiveResourceTest;
...
/**
 * The {@code BaseGetPageChildDomainCrudRestReactiveResourceTest} interface represents a set of RESTful-specific test methods for retrieving a page of entities.
 * It extends both the {@code BaseGetPageChildDomainCrudReactiveResourceTest} and {@code BaseEmbeddedDomainCrudRestReactiveResourceTest} interfaces, providing RESTful-specific testing capabilities.
 * <p>
 ...
 */
public interface BaseGetPageChildDomainCrudRestReactiveResourceTest<
        ...
        extends BaseGetPageChildDomainCrudReactiveResourceTest<ID, USER, D, DTO, C, R, S, DP>,
