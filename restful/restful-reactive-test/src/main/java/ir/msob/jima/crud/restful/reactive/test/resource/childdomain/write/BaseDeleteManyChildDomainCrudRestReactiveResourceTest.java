...
import ir.msob.jima.crud.reactive.test.resource.childdomain.write.BaseDeleteManyChildDomainCrudReactiveResourceTest;
...
/**
 * The {@code BaseDeleteManyChildDomainCrudRestReactiveResourceTest} interface represents a set of RESTful-specific test methods for deleting multiple entities.
 * It extends both the {@code BaseDeleteManyChildDomainCrudReactiveResourceTest} and {@code BaseEmbeddedDomainCrudRestReactiveResourceTest} interfaces, providing RESTful-specific testing capabilities.
 * <p>
 ...
 */
public interface BaseDeleteManyChildDomainCrudRestReactiveResourceTest<
        ...
        extends BaseDeleteManyChildDomainCrudReactiveResourceTest<ID, USER, D, DTO, C, R, S, DP>,
