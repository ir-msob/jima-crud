...
import ir.msob.jima.crud.reactive.test.resource.childdomain.read.BaseGetOneChildDomainCrudReactiveResourceTest;
import ir.msob.jima.crud.reactive.test.resource.domain.read.BaseGetOneDomainCrudReactiveResourceTest;
...
/**
 * The {@code BaseGetOneChildDomainCrudRestReactiveResourceTest} interface represents a set of RESTful-specific test methods for retrieving a single entity.
 * It extends both the {@code BaseGetOneChildDomainCrudReactiveResourceTest} and {@code BaseEmbeddedDomainCrudRestReactiveResourceTest} interfaces, providing RESTful-specific testing capabilities.
 * <p>
 ...
 * @see BaseGetOneDomainCrudReactiveResourceTest
 * @see ParentChildDomainCrudRestResourceTest
 */
public interface BaseGetOneChildDomainCrudRestReactiveResourceTest<
        ...
        extends BaseGetOneChildDomainCrudReactiveResourceTest<ID, USER, D, DTO, C, R, S, DP>,
