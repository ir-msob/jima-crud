...
import ir.msob.jima.crud.reactive.test.resource.childdomain.write.BaseEditByIdChildDomainCrudReactiveResourceTest;
...
/**
 * The {@code BaseEditByIdChildDomainCrudRestReactiveResourceTest} interface represents a set of RESTful-specific test methods for editing an entity by its ID.
 * It extends both the {@code BaseEditByIdChildDomainCrudReactiveResourceTest} and {@code BaseEmbeddedDomainCrudRestReactiveResourceTest} interfaces, providing RESTful-specific testing capabilities.
 * <p>
 ...
 */
public interface BaseEditByIdChildDomainCrudRestReactiveResourceTest<
        ...
        extends BaseEditByIdChildDomainCrudReactiveResourceTest<ID, USER, D, DTO, C, R, S, DP>,
    ...
    @SneakyThrows
    @Override
    default void editByIdRequest(ID parentId, DTO savedDto, JsonPatch jsonPatch, Assertable<DTO> assertable) {
