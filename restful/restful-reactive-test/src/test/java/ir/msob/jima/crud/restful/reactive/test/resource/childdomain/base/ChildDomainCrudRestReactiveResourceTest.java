...
import ir.msob.jima.crud.restful.reactive.test.resource.childdomain.BaseChildDomainCrudRestReactiveResourceTest;
...
public abstract class ChildDomainCrudRestReactiveResourceTest<
        ...
        implements BaseChildDomainCrudRestReactiveResourceTest<String, ProjectUser, D, DTO, C, R, S, DP> {
