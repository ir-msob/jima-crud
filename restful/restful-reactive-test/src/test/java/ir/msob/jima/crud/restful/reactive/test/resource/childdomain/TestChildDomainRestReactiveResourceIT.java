...
import ir.msob.jima.crud.restful.reactive.test.resource.childdomain.base.ChildDomainCrudRestReactiveResourceTest;
...
@Testcontainers
@CommonsLog
class TestChildDomainRestReactiveResourceIT extends ChildDomainCrudRestReactiveResourceTest<TestChildDomain, TestChildDto, TestChildCriteria, TestChildRepository, TestChildServiceDomain, TestChildDataProvider> {
