...
import ir.msob.jima.crud.restful.reactive.test.resource.domain.base.DomainCrudRestReactiveResourceTest;
...
@Testcontainers
@CommonsLog
class TestDomainRestReactiveResourceIT extends DomainCrudRestReactiveResourceTest<TestDomain, TestDto, TestCriteria, TestRepository, TestDomainService, TestDataProvider> {
    ...
    public Class<? extends BaseResource<String, ProjectUser>> getResourceClass() {
        return TestDomainRestReactiveResource.class;
    }
