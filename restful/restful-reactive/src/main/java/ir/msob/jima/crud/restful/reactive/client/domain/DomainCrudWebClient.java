package ir.msob.jima.crud.restful.reactive.client.domain;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.github.fge.jsonpatch.JsonPatch;
import ir.msob.jima.crud.reactive.client.BaseCrudReactiveClient;
import ir.msob.jima.crud.restful.core.util.RestUtil;
import ir.msob.jima.platform.api.domain.criteria.BaseDomainCriteria;
import ir.msob.jima.platform.api.domain.domain.DomainInfo;
import ir.msob.jima.platform.api.domain.dto.BaseDomainDto;
import ir.msob.jima.platform.api.domain.dto.DtoInfo;
...
import ir.msob.jima.platform.api.util.ObjectToParam;
import ir.msob.jima.platform.api.util.Strings;
import ir.msob.jima.platform.reactive.util.RetryUtil;
import ir.msob.jima.platform.restful.api.client.BaseWebClient;
...
/**
 * The `DomainCrudWebClient` class provides a client for performing CRUD (Create, Read, Update, Delete) operations over a RESTful API.
...
public class DomainCrudWebClient implements BaseCrudReactiveClient, BaseWebClient {
    ...
    @MethodStats
    @Override
    public <ID extends Comparable<ID> & Serializable, USER extends BaseUser, DTO extends BaseDomainDto<ID>, C extends BaseDomainCriteria<ID>> Mono<@NonNull Collection<ID>> deleteAll(Class<DTO> dtoClass, C criteria, USER user) {
    ...
    @MethodStats
    @Override
    public <ID extends Comparable<ID> & Serializable, USER extends BaseUser, DTO extends BaseDomainDto<ID>> Mono<@NonNull ID> deleteById(Class<DTO> dtoClass, ID id, USER user) {
        return webClient
                .delete()
    ...
    @MethodStats
    @Override
    public <ID extends Comparable<ID> & Serializable, USER extends BaseUser, DTO extends BaseDomainDto<ID>, C extends BaseDomainCriteria<ID>> Mono<@NonNull ID> delete(Class<DTO> dtoClass, C criteria, USER user) {
        return webClient
                .delete()
    ...
    @MethodStats
    @Override
    public <ID extends Comparable<ID> & Serializable, USER extends BaseUser, DTO extends BaseDomainDto<ID>, C extends BaseDomainCriteria<ID>> Mono<@NonNull Collection<ID>> deleteMany(Class<DTO> dtoClass, C criteria, USER user) {
        return webClient
                .delete()
    ...
    @MethodStats
    @Override
    public <ID extends Comparable<ID> & Serializable, USER extends BaseUser, DTO extends BaseDomainDto<ID>> Mono<@NonNull DTO> editById(Class<DTO> dtoClass, ID id, JsonPatch jsonPatch, USER user) {
        return webClient
                .patch()
                .uri(builder -> getUriWithId(builder, dtoClass, id.toString()))
                .headers(builder -> setDefaultHeaders(builder, user))
    ...
    @MethodStats
    @Override
    public <ID extends Comparable<ID> & Serializable, USER extends BaseUser, DTO extends BaseDomainDto<ID>, C extends BaseDomainCriteria<ID>> Mono<@NonNull DTO> edit(Class<DTO> dtoClass, JsonPatch jsonPatch, C criteria, USER user) {
        return webClient
                .patch()
    ...
    @MethodStats
    @Override
    public <ID extends Comparable<ID> & Serializable, USER extends BaseUser, DTO extends BaseDomainDto<ID>, C extends BaseDomainCriteria<ID>> Mono<@NonNull Collection<DTO>> editMany(Class<DTO> dtoClass, JsonPatch jsonPatch, C criteria, USER user) {
        return webClient
                .patch()
    ...
    @MethodStats
    @Override
    public <ID extends Comparable<ID> & Serializable, USER extends BaseUser, DTO extends BaseDomainDto<ID>> Mono<@NonNull DTO> save(Class<DTO> dtoClass, DTO dto, USER user) {
        return webClient
                .post()
    ...
    @MethodStats
    @Override
    public <ID extends Comparable<ID> & Serializable, USER extends BaseUser, DTO extends BaseDomainDto<ID>> Mono<@NonNull Collection<DTO>> saveMany(Class<DTO> dtoClass, Collection<DTO> dtos, USER user) {
        return webClient
                .post()
    ...
    @MethodStats
    @Override
    public <ID extends Comparable<ID> & Serializable, USER extends BaseUser, DTO extends BaseDomainDto<ID>> Mono<@NonNull DTO> updateById(Class<DTO> dtoClass, ID id, DTO dto, USER user) {
        return webClient
                .put()
                .uri(builder -> getUriWithId(builder, dtoClass, id.toString()))
                .headers(builder -> setDefaultHeaders(builder, user))
    ...
    @MethodStats
    @Override
    public <ID extends Comparable<ID> & Serializable, USER extends BaseUser, DTO extends BaseDomainDto<ID>> Mono<@NonNull DTO> update(Class<DTO> dtoClass, DTO dto, USER user) {
        return webClient
                .put()
    ...
    @MethodStats
    @Override
    public <ID extends Comparable<ID> & Serializable, USER extends BaseUser, DTO extends BaseDomainDto<ID>> Mono<@NonNull Collection<DTO>> updateMany(Class<DTO> dtoClass, Collection<DTO> dtos, USER user) {
        return webClient
                .put()
    ...
    @MethodStats
    @Override
    public <ID extends Comparable<ID> & Serializable, USER extends BaseUser, DTO extends BaseDomainDto<ID>, C extends BaseDomainCriteria<ID>> Mono<@NonNull Long> count(Class<DTO> dtoClass, C criteria, USER user) {
        return webClient
                .get()
                ...
                .retryWhen(RetryUtil.createRetryBackoffSpec(clientProperties.getRetryRequest()));
    }
    ...
    @MethodStats
    @Override
    public <ID extends Comparable<ID> & Serializable, USER extends BaseUser, DTO extends BaseDomainDto<ID>> Mono<@NonNull Long> countAll(Class<DTO> dtoClass, USER user) {
        return webClient
                .get()
    ...
    @MethodStats
    @Override
    public <ID extends Comparable<ID> & Serializable, USER extends BaseUser, DTO extends BaseDomainDto<ID>> Mono<@NonNull DTO> getById(Class<DTO> dtoClass, ID id, USER user) {
        return webClient
                .get()
                .uri(builder -> getUriWithId(builder, dtoClass, id.toString()))
                .headers(builder -> setDefaultHeaders(builder, user))
    ...
    @MethodStats
    @Override
    public <ID extends Comparable<ID> & Serializable, USER extends BaseUser, DTO extends BaseDomainDto<ID>, C extends BaseDomainCriteria<ID>> Mono<@NonNull DTO> getOne(Class<DTO> dtoClass, C criteria, USER user) {
        return webClient
                .get()
    ...
    @MethodStats
    @Override
    public <ID extends Comparable<ID> & Serializable, USER extends BaseUser, DTO extends BaseDomainDto<ID>, C extends BaseDomainCriteria<ID>> Mono<@NonNull Collection<DTO>> getMany(Class<DTO> dtoClass, C criteria, USER user) {
        return webClient
                .get()
    ...
    @MethodStats
    @Override
    public <ID extends Comparable<ID> & Serializable, USER extends BaseUser, DTO extends BaseDomainDto<ID>, C extends BaseDomainCriteria<ID>> Flux<@NonNull DTO> getStream(Class<DTO> dtoClass, C criteria, USER user) {
        return webClient
                .get()
    ...
    @MethodStats
    @Override
    public <ID extends Comparable<ID> & Serializable, USER extends BaseUser, DTO extends BaseDomainDto<ID>, C extends BaseDomainCriteria<ID>> Mono<@NonNull PageDto<DTO>> getPage(Class<DTO> dtoClass, C criteria, USER user) {
        return webClient
                .get()
                ...
                .map(res -> {
                    ...
                    return PageDto.from(new PageImpl<>(dtos, page.getPageable(), page.getTotalElements()));
                });
    }
     ...
     */
    @SneakyThrows
    public <ID extends Comparable<ID> & Serializable, DTO extends BaseDomainDto<ID>, C extends BaseDomainCriteria<ID>> URI getUriWithCriteria(UriBuilder builder, Class<DTO> dtoClass, String suffix, C criteria) {
        return getUriWithCriteria(builder, dtoClass, suffix, criteria, null);
    }

    @SneakyThrows
    public <ID extends Comparable<ID> & Serializable, DTO extends BaseDomainDto<ID>, C extends BaseDomainCriteria<ID>> URI getUriWithCriteria(UriBuilder builder, Class<DTO> dtoClass, C criteria) {
     ...
     */
    @SneakyThrows
    public <ID extends Comparable<ID> & Serializable, DTO extends BaseDomainDto<ID>> URI getUriWithId(UriBuilder builder, Class<DTO> dtoClass, String suffix) {
        BaseDomainDto<ID> baseDto = dtoClass.getDeclaredConstructor().newInstance();
     ...
     */
    @SneakyThrows
    public <ID extends Comparable<ID> & Serializable, DTO extends BaseDomainDto<ID>, C extends BaseDomainCriteria<ID>> URI getUriWithCriteria(UriBuilder builder, Class<DTO> dtoClass, String suffix, C criteria, Pageable pageable) {
        BaseDomainDto<ID> baseDto = dtoClass.getDeclaredConstructor().newInstance();
        DomainInfo domainInfo = DomainInfo.info.getAnnotation(baseDto.getClass());
        DtoInfo dtoInfo = DtoInfo.info.getAnnotation(baseDto.getClass());
        return builder
     ...
     */
    @SneakyThrows
    public <ID extends Comparable<ID> & Serializable, DTO extends BaseDomainDto<ID>> URI getUriWithCriteria(UriBuilder builder, Class<DTO> dtoClass, String suffix) {
        BaseDomainDto<ID> baseDto = dtoClass.getDeclaredConstructor().newInstance();
        DomainInfo domainInfo = DomainInfo.info.getAnnotation(baseDto.getClass());
        DtoInfo dtoInfo = DtoInfo.info.getAnnotation(baseDto.getClass());
        return builder
    ...
    public <ID extends Comparable<ID> & Serializable, DTO extends BaseDomainDto<ID>> URI getUriWithCriteria(UriBuilder builder, Class<DTO> dtoClass) {
     ...
     */
    @SneakyThrows
    public <USER extends BaseUser> void setDefaultHeaders(HttpHeaders builder, USER user) {
