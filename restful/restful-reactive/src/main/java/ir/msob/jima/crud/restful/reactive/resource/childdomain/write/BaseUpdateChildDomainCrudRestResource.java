 ...
 */
public interface BaseUpdateChildDomainCrudRestResource<
    ...
    Logger logger = LoggerFactory.getLogger(BaseUpdateChildDomainCrudRestResource.class);
    ...
    default ResponseEntity<@NonNull Mono<@NonNull DTO>> update(@PathVariable("parentDomainId") ID parentId, @RequestBody DTO dto, ServerWebExchange serverWebExchange, Principal principal)
            throws BadRequestException, DomainNotFoundException {
        logger.debug("REST request to update domain, dto: {}", dto);

        USER user = getUser(serverWebExchange, principal);
        Mono<@NonNull DTO> res = this.getService().update(parentId, dto, user);
