...
import ir.msob.jima.crud.reactive.service.domain.read.BaseGetOneDomainCrudReactiveService;
 ...
 */
public interface BaseGetOneDomainCrudRestReactiveResource<
        ...
        S extends BaseGetOneDomainCrudReactiveService<ID, USER, D, DTO, C, R>
        > extends ParentDomainCrudRestReactiveResource<ID, USER, D, DTO, C, R, S> {

    Logger logger = LoggerFactory.getLogger(BaseGetOneDomainCrudRestReactiveResource.class);
