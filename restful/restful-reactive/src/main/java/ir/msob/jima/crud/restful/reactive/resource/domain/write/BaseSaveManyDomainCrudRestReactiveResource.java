...
import ir.msob.jima.crud.reactive.service.domain.write.BaseSaveManyDomainCrudReactiveService;
...
//import ir.msob.jima.crud.reactive.service.domain.write.BaseSaveManyDomainCrudService;
 ...
 */
public interface BaseSaveManyDomainCrudRestReactiveResource<
        ...
        S extends BaseSaveManyDomainCrudReactiveService<ID, USER, D, DTO, C, R>
        > extends ParentDomainCrudRestReactiveResource<ID, USER, D, DTO, C, R, S> {

    Logger logger = LoggerFactory.getLogger(BaseSaveManyDomainCrudRestReactiveResource.class);
