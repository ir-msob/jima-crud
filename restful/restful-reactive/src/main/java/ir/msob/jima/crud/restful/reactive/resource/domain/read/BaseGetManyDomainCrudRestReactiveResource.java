 ...
 */
public interface BaseGetManyDomainCrudRestReactiveResource<
    ...
    Logger logger = LoggerFactory.getLogger(BaseGetManyDomainCrudRestReactiveResource.class);
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Returns the collection of matching domain DTOs", content = @Content(schema = @Schema(implementation = BaseDomainDto.class))),
