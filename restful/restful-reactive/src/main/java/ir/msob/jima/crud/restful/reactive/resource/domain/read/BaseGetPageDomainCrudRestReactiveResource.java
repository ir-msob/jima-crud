...
import ir.msob.jima.crud.reactive.service.domain.read.BaseGetPageDomainCrudReactiveService;
 ...
 */
public interface BaseGetPageDomainCrudRestReactiveResource<
        ...
        S extends BaseGetPageDomainCrudReactiveService<ID, USER, D, DTO, C, R>
        > extends ParentDomainCrudRestReactiveResource<ID, USER, D, DTO, C, R, S> {

    Logger logger = LoggerFactory.getLogger(BaseGetPageDomainCrudRestReactiveResource.class);
