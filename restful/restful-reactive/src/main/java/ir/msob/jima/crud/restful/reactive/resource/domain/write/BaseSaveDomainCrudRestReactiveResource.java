 ...
 */
public interface BaseSaveDomainCrudRestReactiveResource<
        ...
        S extends BaseSaveDomainCrudReactiveService<ID, USER, D, DTO, C, R>
        > extends ParentDomainCrudRestReactiveResource<ID, USER, D, DTO, C, R, S> {

    Logger logger = LoggerFactory.getLogger(BaseSaveDomainCrudRestReactiveResource.class);
