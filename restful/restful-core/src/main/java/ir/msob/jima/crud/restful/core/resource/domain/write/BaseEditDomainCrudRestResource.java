...
public interface BaseEditDomainCrudRestResource<
    ...
    default ResponseEntity<@NonNull DTO> edit(@RequestBody String dto, C criteria, HttpServletRequest request, Principal principal)
        ...
        DTO res = this.getService().edit(criteria, JsonPatch.fromJson(getService().getObjectMapper().readTree(dto)), user);
