package ir.msob.jima.crud.test.child.relatedobject.relatedparty;
 ...
 */
public interface BaseRelatedPartyCrudResourceTest<
    ...
    default String getElement() {
        return Elements.RELATED_PARTY;
    }

    @Override
    default Function<DTO, SortedSet<CHILD>> getChildGetter() {
        return DTO::getRelatedParties;
    }
}