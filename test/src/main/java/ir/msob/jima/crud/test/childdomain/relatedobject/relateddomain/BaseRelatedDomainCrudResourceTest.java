package ir.msob.jima.crud.test.childdomain.relatedobject.relateddomain;
...
public interface BaseRelatedDomainCrudResourceTest<
        ...
        extends BaseRelatedObjectCrudResourceTest<ID, ID, USER, CD, CC, D, DTO, C, Q, R, S, DP, CS, CDP> {
