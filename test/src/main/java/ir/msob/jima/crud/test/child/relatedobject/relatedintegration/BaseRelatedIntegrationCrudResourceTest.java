package ir.msob.jima.crud.test.child.relatedobject.relatedintegration;
...
public interface BaseRelatedIntegrationCrudResourceTest<
        ...
        extends BaseRelatedObjectCrudResourceTest<ID, String, USER, CHILD, CHILD_C, CNT, D, DTO, C, Q, R, S, DP, CHILD_S, CHILD_DP> {
    ...
    default Function<DTO, SortedSet<CHILD>> getChildGetter() {
        return DTO::getRelatedIntegrations;
    }
}