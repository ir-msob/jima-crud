package ir.msob.jima.crud.test.child.relatedaction;
 ...
 */
public interface BaseRelatedActionCrudResourceTest<
    ...
    default String getElement() {
        return Elements.RELATED_ACTION;
    }

    @Override
    default Function<DTO, SortedSet<CHILD>> getChildGetter() {
        return DTO::getRelatedActions;
    }
}