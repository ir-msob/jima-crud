 ...
 */
public interface BaseDeleteDomainCrudService<ID extends Comparable<ID> & Serializable, USER extends BaseUser, D extends BaseDomain<ID>, DTO extends BaseDomainDto<ID>, C extends BaseDomainCriteria<ID>, R extends BaseRepository<ID, D, C>> extends ParentWriteDomainCrudService<ID, USER, D, DTO, C, R> {
    Logger logger = LoggerFactory.getLogger(BaseDeleteDomainCrudService.class);
    ...
    @Transactional
    @MethodStats
    default ID delete(ID id, USER user) throws DomainNotFoundException, BadRequestException {
    ...
    @Transactional
    @MethodStats
    default ID delete(C criteria, USER user) throws DomainNotFoundException, BadRequestException {
