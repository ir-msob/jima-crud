 ...
 */
public interface BaseDeleteAllDomainCrudService<ID extends Comparable<ID> & Serializable, USER extends BaseUser, D extends BaseDomain<ID>, DTO extends BaseDomainDto<ID>, C extends BaseDomainCriteria<ID>, R extends BaseRepository<ID, D, C>> extends ParentWriteDomainCrudService<ID, USER, D, DTO, C, R> {
    Logger logger = LoggerFactory.getLogger(BaseDeleteAllDomainCrudService.class);
    ...
    @Transactional
    @MethodStats
    default @NonNull Collection<ID> deleteAll(USER user) throws DomainNotFoundException, BadRequestException {
