 ...
 */
public interface BaseUpdateDomainCrudService<ID extends Comparable<ID> & Serializable, USER extends BaseUser, D extends BaseDomain<ID>, DTO extends BaseDomainDto<ID>, C extends BaseDomainCriteria<ID>, R extends BaseRepository<ID, D, C>> extends ParentWriteDomainCrudService<ID, USER, D, DTO, C, R> {
    Logger logger = LoggerFactory.getLogger(BaseUpdateDomainCrudService.class);
    ...
    @Transactional
    @MethodStats
    default @NonNull DTO update(ID id, @Valid DTO dto, USER user) {
        dto.setId(id);
    ...
    @Transactional
    @MethodStats
    default @NonNull DTO update(@Valid DTO dto, USER user) {
        return doUpdate(dto, user);
    }
    ...
    @Transactional
    @MethodStats
    default @NonNull DTO update(DTO previousDto, @Valid DTO dto, USER user) throws BadRequestException, ValidationException, DomainNotFoundException {
