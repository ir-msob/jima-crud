...
public interface BaseGetPageDomainCrudService<ID extends Comparable<ID> & Serializable, USER extends BaseUser,
    ...
    @MethodStats
    default @NonNull Page<@NonNull DTO> getPage(Pageable pageable, USER user) throws DomainNotFoundException, BadRequestException {
    ...
    @Transactional(readOnly = true)
    @MethodStats
    default @NonNull Page<@NonNull DTO> getPage(C criteria, Pageable pageable, USER user) throws DomainNotFoundException, BadRequestException {
