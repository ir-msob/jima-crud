...
public interface BaseGetOneDomainCrudService<ID extends Comparable<ID> & Serializable, USER extends BaseUser,
    ...
    @MethodStats
    default DTO getOne(ID id, USER user) throws DomainNotFoundException, BadRequestException {
    ...
    @Transactional(readOnly = true)
    @MethodStats
    default DTO getOne(C criteria, USER user) throws DomainNotFoundException, BadRequestException {
