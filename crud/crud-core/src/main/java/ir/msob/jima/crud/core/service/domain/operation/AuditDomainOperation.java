 ...
 */
@Component
public class AuditDomainOperation implements BaseLifecycleOperation {
    @Override
    public <ID extends Comparable<ID> & Serializable, USER extends BaseUser, DTO extends BaseElementDto<ID>> void beforeUpdate(DTO previousDto, DTO dto, USER user) throws DomainNotFoundException, BadRequestException {
        addAudit(dto, ir.msob.jima.platform.api.embeddeddomain.model.auditdomain.AuditDomainActionType.UPDATE, user);
        BaseLifecycleOperation.super.beforeUpdate(previousDto, dto, user);
    }

    @Override
    public <ID extends Comparable<ID> & Serializable, USER extends BaseUser, DTO extends BaseElementDto<ID>> void beforeSave(DTO dto, USER user) throws DomainNotFoundException, BadRequestException {
        addAudit(dto, AuditDomainActionType.CREATE, user);
        BaseLifecycleOperation.super.beforeSave(dto, user);
    }
