 ...
 */
public interface BaseGetStreamDomainCrudReactiveService<ID extends Comparable<ID> & Serializable, USER extends BaseUser,
     ...
     */
    Logger logger = LoggerFactory.getLogger(BaseGetStreamDomainCrudReactiveService.class);
