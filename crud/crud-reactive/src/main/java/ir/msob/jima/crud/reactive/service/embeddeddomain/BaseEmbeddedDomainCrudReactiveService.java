package ir.msob.jima.crud.reactive.service.embeddeddomain;
...
import ir.msob.jima.platform.api.exception.datanotfound.DataNotFoundException;
 ...
 */
public interface BaseEmbeddedDomainCrudReactiveService<
    ...
    default Class<DTO> getParentDtoClass() {
        return (Class<DTO>) GenericTypeUtil.resolveTypeArguments(this.getClass(), BaseEmbeddedDomainCrudReactiveService.class, 2);
    }
