 ...
 */
public interface BaseCountDomainCrudReactiveService<ID extends Comparable<ID> & Serializable, USER extends BaseUser,
    ...
    Logger logger = LoggerFactory.getLogger(BaseCountDomainCrudReactiveService.class);
