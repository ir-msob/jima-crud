 ...
 */
public interface BaseGetManyDomainCrudReactiveService<ID extends Comparable<ID> & Serializable, USER extends BaseUser,
     ...
     */
    Logger logger = LoggerFactory.getLogger(BaseGetManyDomainCrudReactiveService.class);
