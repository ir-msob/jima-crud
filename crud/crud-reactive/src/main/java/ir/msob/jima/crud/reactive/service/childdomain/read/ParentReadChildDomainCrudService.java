 ...
 * @param <DTO>  The type of the DTO (Data Transfer Object) entities. It must extend BaseDomainDto.
 * @param <C>    The type of the criteria used for filtering entities. It must extend BaseDomainCriteria.
 * @param <R>    The type of the CRUD repository used for data access. It must extend BaseReactiveRepository.
 */
public interface ParentReadChildDomainCrudService<ID extends Comparable<ID> & Serializable, USER extends BaseUser,
        ...
        extends ParentChildDomainCrudService<ID, USER, D, DTO, C, R> {
