...
/**
 * This class provides test data for the {@link TestDomain} class. It extends the {@link ChildDomainCrudDataProvider} class
...
public class TestChildDataProvider extends ChildDomainCrudDataProvider<TestChildDomain, TestChildDto, TestChildCriteria, TestChildRepository, TestChildServiceDomain> {
    ...
    public TestChildDataProvider(BaseIdService idService, ObjectMapper objectMapper, TestChildServiceDomain service) {
