...
import static ir.msob.jima.platform.test.data.CoreTestData.DEFAULT_STRING;
import static ir.msob.jima.platform.test.data.CoreTestData.UPDATED_STRING;
 ...
 */
@Component
public class TestDataProvider extends DomainCrudDataProvider<TestDomain, TestDto, TestCriteria, TestRepository, TestDomainService> {

    private static TestDto newDto;
    private static TestDto newMandatoryDto;

    public TestDataProvider(BaseIdService idService, ObjectMapper objectMapper, TestDomainService service) {
