...
/**
 * The {@code BaseEditChildDomainCrudResourceTest} interface defines test cases for the edit functionality of a CRUD resource.
 * It extends the {@code ParentChildDomainCrudResourceTest} interface and provides methods to test the edit operation for CRUD resources.
 ...
 */
public interface BaseEditChildDomainCrudResourceTest<
    ...
    default void edit() throws BadRequestException, DomainNotFoundException, ExecutionException, InterruptedException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
        ...
        editRequest(parentId, savedDtoForUpdate, getDataProvider().getJsonPatch(), updatedDto -> getDataProvider().assertUpdate(savedDto, updatedDto));
    ...
    default void editMandatory() throws BadRequestException, DomainNotFoundException, ExecutionException, InterruptedException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
        ...
        Long countBefore = getDataProvider().countDb();
        editRequest(parentId, savedDtoForUpdate, getDataProvider().getMandatoryJsonPatch(),
     ...
     * @throws DomainNotFoundException If the domain is not found.
     */
    void editRequest(ID parentId, DTO savedDto, JsonPatch jsonPatch, Assertable<DTO> assertable);
}
