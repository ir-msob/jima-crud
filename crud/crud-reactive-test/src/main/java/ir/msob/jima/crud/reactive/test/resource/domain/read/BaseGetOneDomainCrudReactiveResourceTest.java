package ir.msob.jima.crud.reactive.test.resource.domain.read;
 ...
 */
public interface BaseGetOneDomainCrudReactiveResourceTest<
    ...
    void getOneRequest(DTO savedDto, Assertable<DTO> assertable);
}
