...
/**
 * The {@code BaseGetManyChildDomainCrudResourceTest} interface defines test cases for the getMany functionality of a CRUD resource.
 * It extends the {@code ParentChildDomainCrudResourceTest} interface and provides methods to test the getMany operation for CRUD resources.
 ...
 */
public interface BaseGetManyChildDomainCrudResourceTest<
    ...
    default void getMany() throws BadRequestException, DomainNotFoundException, ExecutionException, InterruptedException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
        ...
        getManyRequest(parentId, savedDto, dtos -> {
    ...
    void getManyRequest(ID parentId, DTO savedDto, Assertable<Collection<DTO>> assertable);
}
