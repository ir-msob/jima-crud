...
/**
 * The {@code BaseCountChildDomainCrudResourceTest} interface defines test cases for the count functionality of a CRUD resource.
 * It extends the {@code ParentChildDomainCrudResourceTest} interface and provides methods to test the count operation for CRUD resources.
 ...
 */
public interface BaseCountChildDomainCrudResourceTest<
    ...
    default void count() throws BadRequestException, DomainNotFoundException, ExecutionException, InterruptedException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
        ...
        this.countRequest(parentId, savedDto, count -> Assertions.assertThat(count).isEqualTo(1));
    ...
    void countRequest(ID parentId, DTO savedDto, Assertable<Long> assertable);
}
