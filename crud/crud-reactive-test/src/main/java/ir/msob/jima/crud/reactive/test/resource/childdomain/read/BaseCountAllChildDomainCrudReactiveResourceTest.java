...
/**
 * The {@code BaseCountAllChildDomainCrudReactiveResourceTest} interface defines test cases for the countAll functionality of a CRUD resource.
 * It extends the {@code ParentChildDomainCrudReactiveResourceTest} interface and provides methods to test the countAll operation for CRUD resources.
 ...
 */
public interface BaseCountAllChildDomainCrudReactiveResourceTest<
    ...
    default void countAll() throws BadRequestException, DomainNotFoundException, ExecutionException, InterruptedException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
        ...
        this.countAllRequest(parentId, count -> assertEquals(1, count));
    ...
    void countAllRequest(ID parentId, Assertable<Long> assertable);
}
