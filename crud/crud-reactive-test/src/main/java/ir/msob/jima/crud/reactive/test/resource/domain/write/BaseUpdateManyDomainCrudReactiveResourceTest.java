...
/**
 * The {@code BaseUpdateManyChildDomainCrudReactiveResourceTest} interface defines test cases for the updateMany functionality of a CRUD resource.
 * It extends the {@code ParentChildDomainCrudReactiveResourceTest} interface and provides methods to test the updateMany operation for CRUD resources.
 ...
 */
public interface BaseUpdateManyDomainCrudReactiveResourceTest<
    ...
    default void updateMany() throws BadRequestException, DomainNotFoundException, ExecutionException, InterruptedException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
        ...
        updateManyRequest(Collections.singleton(savedDtoForUpdate), updatedDtos -> {
