...
import ir.msob.jima.crud.rsocket.reactive.test.resource.domain.BaseDomainCrudRsocketReactiveResourceTest;
...
public abstract class DomainCrudRsocketReactiveResourceTest<
        ...
        implements BaseDomainCrudRsocketReactiveResourceTest<String, ProjectUser, D, DTO, C, R, S, DP> {
