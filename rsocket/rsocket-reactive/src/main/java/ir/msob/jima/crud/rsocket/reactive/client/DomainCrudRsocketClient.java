package ir.msob.jima.crud.rsocket.reactive.client;
...
/**
 * The `DomainCrudRsocketClient` class provides a client for performing CRUD (Create, Read, Update, Delete) operations over a RESTful API.
...
public class DomainCrudRsocketClient implements BaseCrudReactiveClient {
     ...
     */
    public static <ID extends Comparable<ID> & Serializable, DTO extends BaseDomainDto<ID>> String prepareRoute(Class<DTO> dtoClass, String operation) {
     ...
     */
    private <ID extends Comparable<ID> & Serializable, DTO extends BaseDomainDto<ID>> String prepareApplicationName(Class<DTO> dtoClass) {
     ...
     */
    public <ID extends Comparable<ID> & Serializable, USER extends BaseUser, C extends BaseDomainCriteria<ID>> ChannelMessage<USER, CriteriaMessage<ID, C>> createChannelMessage(CriteriaMessage<ID, C> data) {
     ...
     */
    public <ID extends Comparable<ID> & Serializable, USER extends BaseUser, C extends BaseDomainCriteria<ID>> ChannelMessage<USER, JsonPatchMessage<ID, C>> createChannelMessage(JsonPatchMessage<ID, C> data) {
     ...
     */
    public <ID extends Comparable<ID> & Serializable, USER extends BaseUser, DTO extends BaseDomainDto<ID>> ChannelMessage<USER, DtosMessage<ID, DTO>> createChannelMessage(DtosMessage<ID, DTO> data) {
     ...
     * @return A ChannelMessage containing the provided data.
     */
    public <ID extends Comparable<ID> & Serializable, DTO extends BaseDomainDto<ID>> DtosMessage<ID, DTO> createMessage(Collection<DTO> dtos) {
