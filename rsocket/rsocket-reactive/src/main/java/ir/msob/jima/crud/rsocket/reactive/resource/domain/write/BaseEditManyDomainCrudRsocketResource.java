...
import ir.msob.jima.crud.reactive.service.domain.write.BaseEditManyDomainCrudReactiveService;
 ...
 * It extends the ParentDomainCrudRsocketResource interface and provides a default implementation for the editMany method.
 *
 ...
 * @author Yaqub Abdi
 */
public interface BaseEditManyDomainCrudRsocketResource<
        ...
        S extends BaseEditManyDomainCrudReactiveService<ID, USER, D, DTO, C, R>
