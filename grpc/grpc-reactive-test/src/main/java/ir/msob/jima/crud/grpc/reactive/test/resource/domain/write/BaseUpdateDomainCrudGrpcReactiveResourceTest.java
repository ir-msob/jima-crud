...
import ir.msob.jima.crud.test.resource.domain.write.BaseUpdateDomainCrudResourceTest;
...
/**
 * The {@code BaseUpdateDomainCrudGrpcReactiveResourceTest} interface represents a set of gRPC-specific test methods for updating an entity.
 * It extends both the {@code BaseUpdateChildDomainCrudReactiveResourceTest} and {@code ParentDomainCrudGrpcReactiveResourceTest} interfaces, providing gRPC-specific testing capabilities.
 * <p>
 ...
 */
public interface BaseUpdateDomainCrudGrpcReactiveResourceTest<
        ...
        extends BaseUpdateDomainCrudReactiveResourceTest<ID, USER, D, DTO, C, R, S, DP>,
    ...
    default void updateRequest(DTO dto, Assertable<DTO> assertable) {
        ...
        DtoMsg res = getCrudServiceBlockingStub()
                .update(msg);
