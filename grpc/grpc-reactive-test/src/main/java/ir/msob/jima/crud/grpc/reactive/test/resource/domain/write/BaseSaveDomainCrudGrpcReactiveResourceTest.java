...
import ir.msob.jima.crud.test.resource.domain.write.BaseSaveDomainCrudResourceTest;
...
/**
 * The {@code BaseSaveDomainCrudGrpcReactiveResourceTest} interface represents a set of gRPC-specific test methods for saving an entity.
 * It extends both the {@code BaseSaveChildDomainCrudReactiveResourceTest} and {@code ParentDomainCrudGrpcReactiveResourceTest} interfaces, providing gRPC-specific testing capabilities.
 * <p>
 ...
 */
public interface BaseSaveDomainCrudGrpcReactiveResourceTest<
