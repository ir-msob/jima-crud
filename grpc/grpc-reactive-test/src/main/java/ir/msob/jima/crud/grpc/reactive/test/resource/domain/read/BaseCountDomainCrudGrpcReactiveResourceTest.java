...
import ir.msob.jima.crud.test.resource.domain.read.BaseCountDomainCrudResourceTest;
...
/**
 * The {@code BaseCountDomainCrudGrpcReactiveResourceTest} interface represents a set of gRPC-specific test methods for counting entities based on a given criteria.
 * It extends both the {@code BaseCountChildDomainCrudReactiveResourceTest} and {@code ParentDomainCrudGrpcReactiveResourceTest} interfaces, providing gRPC-specific testing capabilities.
 * <p>
 ...
 */
public interface BaseCountDomainCrudGrpcReactiveResourceTest<
