...
/**
 * The {@code BaseEditManyDomainCrudGrpcReactiveResourceTest} interface represents a set of gRPC-specific test methods for editing multiple entities based on a given criteria.
 * It extends both the {@code BaseEditManyChildDomainCrudReactiveResourceTest} and {@code ParentDomainCrudGrpcReactiveResourceTest} interfaces, providing gRPC-specific testing capabilities.
 * <p>
 ...
 */
public interface BaseEditManyDomainCrudGrpcReactiveResourceTest<
        ...
        extends BaseEditManyDomainCrudReactiveResourceTest<ID, USER, D, DTO, C, R, S, DP>,
