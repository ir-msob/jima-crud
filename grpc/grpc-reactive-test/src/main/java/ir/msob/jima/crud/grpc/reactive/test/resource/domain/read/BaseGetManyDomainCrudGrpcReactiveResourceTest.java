...
import ir.msob.jima.crud.test.resource.domain.read.BaseGetManyDomainCrudResourceTest;
...
/**
 * The {@code BaseGetManyDomainCrudGrpcReactiveResourceTest} interface represents a set of gRPC-specific test methods for retrieving multiple entities based on a given criteria.
 * It extends both the {@code BaseGetManyChildDomainCrudReactiveResourceTest} and {@code ParentDomainCrudGrpcReactiveResourceTest} interfaces, providing gRPC-specific testing capabilities.
 * <p>
 ...
 */
public interface BaseGetManyDomainCrudGrpcReactiveResourceTest<
