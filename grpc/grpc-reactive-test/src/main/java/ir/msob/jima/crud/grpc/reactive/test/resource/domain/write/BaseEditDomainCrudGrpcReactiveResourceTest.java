...
import ir.msob.jima.crud.grpc.reactive.proto.CriteriaJsonPatchMsg;
...
import ir.msob.jima.crud.test.resource.domain.write.BaseEditDomainCrudResourceTest;
...
/**
 * The {@code BaseEditDomainCrudGrpcReactiveResourceTest} interface represents a set of gRPC-specific test methods for editing an entity based on a given criteria.
 * It extends both the {@code BaseEditChildDomainCrudReactiveResourceTest} and {@code ParentDomainCrudGrpcReactiveResourceTest} interfaces, providing gRPC-specific testing capabilities.
 * <p>
 ...
 */
public interface BaseEditDomainCrudGrpcReactiveResourceTest<
        ...
        extends BaseEditDomainCrudReactiveResourceTest<ID, USER, D, DTO, C, R, S, DP>,
