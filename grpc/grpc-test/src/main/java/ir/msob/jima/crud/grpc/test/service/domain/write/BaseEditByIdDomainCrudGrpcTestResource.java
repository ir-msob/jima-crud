...
import ir.msob.jima.crud.test.resource.domain.write.BaseEditByIdDomainCrudTestResource;
...
/**
 * The {@code BaseEditByIdDomainCrudGrpcTestResource} interface represents a set of gRPC-specific test methods for editing entities by their ID.
 * It extends both the {@code BaseEditByIdChildDomainCrudTestResource} and {@code ParentDomainCrudGrpcTestResource} interfaces, providing gRPC-specific testing capabilities.
 * <p>
 ...
 * @see BaseEditByIdDomainCrudTestResource
 * @see ParentDomainCrudGrpcTestResource
 */
public interface BaseEditByIdDomainCrudGrpcTestResource<
        ...
        extends BaseEditByIdDomainCrudTestResource<ID, USER, D, DTO, C, R, S, DP>,
