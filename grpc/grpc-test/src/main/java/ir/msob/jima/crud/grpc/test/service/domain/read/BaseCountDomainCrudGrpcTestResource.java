...
import ir.msob.jima.crud.test.resource.domain.read.BaseCountDomainCrudTestResource;
...
/**
 * The {@code BaseCountDomainCrudGrpcTestResource} interface represents a set of gRPC-specific test methods for counting entities based on a given criteria.
 * It extends both the {@code BaseCountChildDomainCrudTestResource} and {@code ParentDomainCrudGrpcTestResource} interfaces, providing gRPC-specific testing capabilities.
 * <p>
 ...
 * @see BaseCountDomainCrudTestResource
 * @see ParentDomainCrudGrpcTestResource
 */
public interface BaseCountDomainCrudGrpcTestResource<
        ...
        extends BaseCountDomainCrudTestResource<ID, USER, D, DTO, C, R, S, DP>,
