...
import ir.msob.jima.crud.test.resource.domain.write.BaseSaveManyDomainCrudTestResource;
...
/**
 * The {@code BaseSaveManyDomainCrudGrpcTestResource} interface represents a set of gRPC-specific test methods for saving multiple entities.
 * It extends both the {@code BaseSaveManyChildDomainCrudTestResource} and {@code ParentDomainCrudGrpcTestResource} interfaces, providing gRPC-specific testing capabilities.
 * <p>
 ...
 * @see BaseSaveManyDomainCrudTestResource
 * @see ParentDomainCrudGrpcTestResource
 */
public interface BaseSaveManyDomainCrudGrpcTestResource<
        ...
        extends BaseSaveManyDomainCrudTestResource<ID, USER, D, DTO, C, R, S, DP>,
