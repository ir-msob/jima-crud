...
import ir.msob.jima.crud.test.resource.domain.read.BaseGetOneDomainCrudTestResource;
...
/**
 * The {@code BaseGetOneDomainCrudGrpcTestResource} interface represents a set of gRPC-specific test methods for retrieving a single entity based on a given criteria.
 * It extends both the {@code BaseGetOneChildDomainCrudTestResource} and {@code ParentDomainCrudGrpcTestResource} interfaces, providing gRPC-specific testing capabilities.
 * <p>
 ...
 * @see BaseGetOneDomainCrudTestResource
 * @see ParentDomainCrudGrpcTestResource
 */
public interface BaseGetOneDomainCrudGrpcTestResource<
        ...
        extends BaseGetOneDomainCrudTestResource<ID, USER, D, DTO, C, R, S, DP>,
