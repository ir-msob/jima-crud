...
import ir.msob.jima.crud.test.resource.domain.write.BaseEditManyDomainCrudTestResource;
...
/**
 * The {@code BaseEditManyDomainCrudGrpcTestResource} interface represents a set of gRPC-specific test methods for editing multiple entities based on a given criteria.
 * It extends both the {@code BaseEditManyChildDomainCrudTestResource} and {@code ParentDomainCrudGrpcTestResource} interfaces, providing gRPC-specific testing capabilities.
 * <p>
 ...
 * @see BaseEditManyDomainCrudTestResource
 * @see ParentDomainCrudGrpcTestResource
 */
public interface BaseEditManyDomainCrudGrpcTestResource<
        ...
        extends BaseEditManyDomainCrudTestResource<ID, USER, D, DTO, C, R, S, DP>,
