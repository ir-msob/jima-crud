...
import ir.msob.jima.crud.test.resource.domain.read.BaseCountAllDomainCrudTestResource;
...
/**
 * The {@code BaseCountAllDomainCrudGrpcTestResource} interface represents a set of gRPC-specific test methods for counting all entities.
 * It extends both the {@code BaseCountAllChildDomainCrudTestResource} and {@code ParentDomainCrudGrpcTestResource} interfaces, providing gRPC-specific testing capabilities.
 * <p>
 ...
 * @see BaseCountAllDomainCrudTestResource
 * @see ParentDomainCrudGrpcTestResource
 */
public interface BaseCountAllDomainCrudGrpcTestResource<
        ...
        extends BaseCountAllDomainCrudTestResource<ID, USER, D, DTO, C, R, S, DP>,
