...
import ir.msob.jima.crud.test.resource.domain.write.BaseEditDomainCrudTestResource;
...
/**
 * The {@code BaseEditDomainCrudGrpcTestResource} interface represents a set of gRPC-specific test methods for editing an entity based on a given criteria.
 * It extends both the {@code BaseEditChildDomainCrudTestResource} and {@code ParentDomainCrudGrpcTestResource} interfaces, providing gRPC-specific testing capabilities.
 * <p>
 ...
 * @see BaseEditDomainCrudTestResource
 * @see ParentDomainCrudGrpcTestResource
 */
public interface BaseEditDomainCrudGrpcTestResource<
        ...
        extends BaseEditDomainCrudTestResource<ID, USER, D, DTO, C, R, S, DP>,
