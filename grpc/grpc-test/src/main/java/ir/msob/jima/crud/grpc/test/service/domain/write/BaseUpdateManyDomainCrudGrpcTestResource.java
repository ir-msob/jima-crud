...
import ir.msob.jima.crud.test.resource.domain.write.BaseUpdateManyDomainCrudTestResource;
...
/**
 * The {@code BaseUpdateManyDomainCrudGrpcTestResource} interface represents a set of gRPC-specific test methods for updating multiple entities.
 * It extends both the {@code BaseUpdateManyChildDomainCrudTestResource} and {@code ParentDomainCrudGrpcTestResource} interfaces, providing gRPC-specific testing capabilities.
 * <p>
 ...
 * @see BaseUpdateManyDomainCrudTestResource
 * @see ParentDomainCrudGrpcTestResource
 */
public interface BaseUpdateManyDomainCrudGrpcTestResource<
        ...
        extends BaseUpdateManyDomainCrudTestResource<ID, USER, D, DTO, C, R, S, DP>,
