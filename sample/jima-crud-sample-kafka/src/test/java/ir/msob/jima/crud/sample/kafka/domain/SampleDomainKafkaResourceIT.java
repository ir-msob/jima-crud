...
import ir.msob.jima.crud.sample.kafka.JimaApplication;
import ir.msob.jima.crud.sample.kafka.base.CrudKafkaResourceTest;
...
@Testcontainers
@CommonsLog
public class SampleDomainKafkaResourceIT extends CrudKafkaResourceTest<SampleDomain, SampleDto, SampleCriteria, SampleRepository, SampleService, SampleDomainDataProvider> {
    ...
    public String getBaseUri() {
        return SampleDomainKafkaResource.BASE_URI;
    }
