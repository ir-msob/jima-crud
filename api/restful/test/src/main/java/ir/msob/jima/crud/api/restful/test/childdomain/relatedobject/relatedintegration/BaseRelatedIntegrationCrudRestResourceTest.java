package ir.msob.jima.crud.api.restful.test.childdomain.relatedobject.relatedintegration;
...
import ir.msob.jima.crud.test.childdomain.relatedobject.relatedintegration.BaseRelatedIntegrationCrudResourceTest;
...
public interface BaseRelatedIntegrationCrudRestResourceTest<
        ...
        BaseRelatedIntegrationCrudResourceTest<ID, USER, CD, CC, D, DTO, C, Q, R, S, DP, CS, CDP> {
