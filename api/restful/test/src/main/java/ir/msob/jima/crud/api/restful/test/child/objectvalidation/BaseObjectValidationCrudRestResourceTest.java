package ir.msob.jima.crud.api.restful.test.child.objectvalidation;
...
import ir.msob.jima.crud.test.child.objectvalidation.BaseObjectValidationCrudResourceTest;
...
public interface BaseObjectValidationCrudRestResourceTest<
        ...
        extends BaseObjectValidationCrudResourceTest<ID, USER, CHILD, CHILD_C, CNT, D, DTO, C, Q, R, S, DP, CHILD_S, CHILD_DP>,
