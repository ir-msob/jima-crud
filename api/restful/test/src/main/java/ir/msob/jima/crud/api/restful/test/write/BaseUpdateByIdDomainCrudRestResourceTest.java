...
import ir.msob.jima.crud.test.write.BaseUpdateByIdDomainCrudResourceTest;
import org.springframework.http.MediaType;

import java.io.Serializable;

/**
 * The {@code BaseUpdateByIdDomainCrudRestResourceTest} interface represents a set of RESTful-specific test methods for updating an entity by its ID.
 * It extends both the {@code BaseUpdateByIdDomainCrudResourceTest} and {@code ParentDomainCrudRestResourceTest} interfaces, providing RESTful-specific testing capabilities.
 * <p>
...
public interface BaseUpdateByIdDomainCrudRestResourceTest<
        ...
        extends BaseUpdateByIdDomainCrudResourceTest<ID, USER, D, DTO, C, Q, R, S, DP>,
