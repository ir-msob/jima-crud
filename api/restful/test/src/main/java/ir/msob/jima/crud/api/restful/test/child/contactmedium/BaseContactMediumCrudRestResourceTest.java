package ir.msob.jima.crud.api.restful.test.child.contactmedium;
...
import ir.msob.jima.crud.test.child.contactmedium.BaseContactMediumCrudResourceTest;
...
public interface BaseContactMediumCrudRestResourceTest<
        ...
        CHILD extends ContactMediumAbstract<ID>,
        CHILD_C extends ContactMediumCriteriaAbstract<ID, CHILD>,
        CNT extends BaseContactMediumContainer<ID, CHILD>,

        D extends BaseDomain<ID>,
        DTO extends BaseDto<ID> & BaseContactMediumContainer<ID, CHILD>,
        ...
        CHILD_S extends BaseContactMediumCrudService<ID, USER, CHILD, CHILD_C, CNT, DTO>,
        CHILD_DP extends BaseChildCrudDataProvider<ID, USER, CHILD, CHILD_C, CNT, DTO, CHILD_S>>
        extends BaseContactMediumCrudResourceTest<ID, USER, CHILD, CHILD_C, CNT, D, DTO, C, Q, R, S, DP, CHILD_S, CHILD_DP>,
