package ir.msob.jima.crud.api.restful.test.child.relatedobject.relatedintegration;
...
import ir.msob.jima.crud.test.child.relatedobject.relatedintegration.BaseRelatedIntegrationCrudResourceTest;
 ...
 */
public interface BaseRelatedIntegrationCrudRestResourceTest<
        ID extends Comparable<ID> & Serializable,
        USER extends BaseUser,

        CHILD extends RelatedIntegrationAbstract<ID>,
        CHILD_C extends RelatedIntegrationCriteriaAbstract<ID, CHILD>,
        CNT extends BaseRelatedIntegrationContainer<ID, CHILD>,

        D extends BaseDomain<ID>,
        DTO extends BaseDto<ID> & BaseRelatedIntegrationContainer<ID, CHILD>,
        ...
        CHILD_S extends BaseRelatedIntegrationCrudService<ID, USER, CHILD, CHILD_C, CNT, DTO>,
        ...
        BaseRelatedIntegrationCrudResourceTest<ID, USER, CHILD, CHILD_C, CNT, D, DTO, C, Q, R, S, DP, CHILD_S, CHILD_DP> {
