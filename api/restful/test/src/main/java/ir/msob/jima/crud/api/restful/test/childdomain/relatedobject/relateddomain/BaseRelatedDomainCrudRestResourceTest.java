package ir.msob.jima.crud.api.restful.test.childdomain.relatedobject.relateddomain;
...
import ir.msob.jima.crud.test.childdomain.relatedobject.relateddomain.BaseRelatedDomainCrudResourceTest;
...
public interface BaseRelatedDomainCrudRestResourceTest<
        ...
        extends BaseRelatedObjectCrudRestResourceTest<ID, ID, USER, CD, CC, D, DTO, C, Q, R, S, DP, CS, CDP>,
        BaseRelatedDomainCrudResourceTest<ID, USER, CD, CC, D, DTO, C, Q, R, S, DP, CS, CDP> {
