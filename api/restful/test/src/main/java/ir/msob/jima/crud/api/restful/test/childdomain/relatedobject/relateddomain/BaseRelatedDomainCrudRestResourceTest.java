...
public interface BaseRelatedDomainCrudRestResourceTest<
        ...
        extends BaseRelatedObjectCrudRestResourceTest<ID, ID, USER, CD, CC, D, DTO, C, R, S, DP, CS, CDP>,
        BaseRelatedDomainCrudResourceTest<ID, USER, CD, CC, D, DTO, C, R, S, DP, CS, CDP> {
