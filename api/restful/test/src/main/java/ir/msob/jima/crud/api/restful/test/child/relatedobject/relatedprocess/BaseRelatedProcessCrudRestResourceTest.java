package ir.msob.jima.crud.api.restful.test.child.relatedobject.relatedprocess;
...
import ir.msob.jima.crud.test.child.relatedobject.relatedprocess.BaseRelatedProcessCrudResourceTest;
...
public interface BaseRelatedProcessCrudRestResourceTest<
        ...
        CHILD extends RelatedProcessAbstract<ID>,
        CHILD_C extends RelatedProcessCriteriaAbstract<ID, CHILD>,
        CNT extends BaseRelatedProcessContainer<ID, CHILD>,

        D extends BaseDomain<ID>,
        DTO extends BaseDto<ID> & BaseRelatedProcessContainer<ID, CHILD>,
        ...
        CHILD_S extends BaseRelatedProcessCrudService<ID, USER, CHILD, CHILD_C, CNT, DTO>,
        ...
        BaseRelatedProcessCrudResourceTest<ID, USER, CHILD, CHILD_C, CNT, D, DTO, C, Q, R, S, DP, CHILD_S, CHILD_DP> {
