...
public interface BaseSaveObjectValidationCrudRestResource<
    ...
    Logger logger = LoggerFactory.getLogger(BaseSaveObjectValidationCrudRestResource.class);
    ...
    default ResponseEntity<@NonNull Mono<@NonNull DTO>> save(
        ...
        logger.debug("REST request to save object validation, parentId {}, childDomain {}", parentId, childDomain);
