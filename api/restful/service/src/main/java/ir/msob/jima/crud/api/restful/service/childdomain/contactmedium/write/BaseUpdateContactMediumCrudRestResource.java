...
public interface BaseUpdateContactMediumCrudRestResource<
    ...
    Logger logger = LoggerFactory.getLogger(BaseUpdateContactMediumCrudRestResource.class);
    ...
    default ResponseEntity<@NonNull Mono<@NonNull DTO>> update(
        ...
        logger.debug("REST request to update contact medium, parentId {}, childDomain {}, childCriteria {}", parentId, childDomain, childCriteria);
