...
public interface BaseUpdateByKeyCharacteristicCrudRestResource<
    ...
    @MethodStats
    @Scope(Operations.UPDATE_BY_KEY)
    default ResponseEntity<Mono<DTO>> updateByKey(@PathVariable("parentId") ID parentId, @PathVariable("key") String key, @RequestBody @Valid CH dto, ServerWebExchange serverWebExchange, Principal principal) throws BadRequestException, DomainNotFoundException {
