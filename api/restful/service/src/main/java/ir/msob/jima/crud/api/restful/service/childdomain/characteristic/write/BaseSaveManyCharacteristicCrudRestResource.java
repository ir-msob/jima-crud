...
public interface BaseSaveManyCharacteristicCrudRestResource<
    ...
    Logger logger = LoggerFactory.getLogger(BaseSaveManyCharacteristicCrudRestResource.class);
    ...
    default ResponseEntity<@NonNull Mono<@NonNull DTO>> saveMany(
        ...
        logger.debug("REST request to save many characteristics, parentId {}, childDomains {}", parentId, childDomains);
