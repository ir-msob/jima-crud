...
public interface BaseUpdateByRelatedIdRelatedDomainCrudRestResource<
    ...
    Logger logger = LoggerFactory.getLogger(BaseUpdateByRelatedIdRelatedDomainCrudRestResource.class);
    ...
    default ResponseEntity<@NonNull Mono<@NonNull DTO>> updateByRelatedId(
        ...
        logger.debug("REST request to update related domain by relatedId, parentId {}, relatedId {}, childDomain {}", parentId, relatedId, childDomain);
