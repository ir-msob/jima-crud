...
public interface BaseUpdateManyObjectValidationCrudRestResource<
    ...
    Logger logger = LoggerFactory.getLogger(BaseUpdateManyObjectValidationCrudRestResource.class);
    ...
    default ResponseEntity<@NonNull Mono<@NonNull DTO>> updateMany(
        ...
        logger.debug("REST request to update many object validations, parentId {}, childDomains {}", parentId, childDomains);
