...
public interface BaseDeleteByRelatedIdRelatedProcessCrudRestResource<
    ...
    Logger logger = LoggerFactory.getLogger(BaseDeleteByRelatedIdRelatedProcessCrudRestResource.class);

    @Operation(summary = "Delete related process by relatedId", description = "Delete a related process child domain by its relatedId for a given parent ID")
    ...
    default ResponseEntity<@NonNull Mono<@NonNull DTO>> deleteByRelatedId(
        ...
        logger.debug("REST request to delete childdomain process by relatedId, parentId {}, relatedId {}", parentId, relatedId);
