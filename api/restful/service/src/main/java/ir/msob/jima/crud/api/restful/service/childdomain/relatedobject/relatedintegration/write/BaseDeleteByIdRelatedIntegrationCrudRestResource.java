...
public interface BaseDeleteByIdRelatedIntegrationCrudRestResource<
    ...
    Logger logger = LoggerFactory.getLogger(BaseDeleteByIdRelatedIntegrationCrudRestResource.class);
    ...
    default ResponseEntity<@NonNull Mono<@NonNull DTO>> deleteById(
        ...
        logger.debug("REST request to delete related integration by id, parentId {}, id {}", parentId, id);
