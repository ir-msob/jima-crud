...
public interface BaseSaveManyContactMediumCrudRestResource<
    ...
    default ResponseEntity<Mono<DTO>> saveMany(@PathVariable("parentId") ID parentId, @RequestBody Collection<@Valid CM> dtos, ServerWebExchange serverWebExchange, Principal principal) throws BadRequestException, DomainNotFoundException {
        log.debug("REST request to save many contact mediums, parentId {}, dtos {}", parentId, dtos);
