...
public interface BaseSaveRelatedPartyCrudRestResource<
    ...
    Logger logger = LoggerFactory.getLogger(BaseSaveRelatedPartyCrudRestResource.class);
    ...
    default ResponseEntity<@NonNull Mono<@NonNull DTO>> save(
        ...
        logger.debug("REST request to save childdomain party, parentId {}, childDomain {}", parentId, childDomain);
