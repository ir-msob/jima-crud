...
public interface BaseUpdateRelatedIntegrationCrudRestResource<
    ...
    Logger logger = LoggerFactory.getLogger(BaseUpdateRelatedIntegrationCrudRestResource.class);
    ...
    default ResponseEntity<@NonNull Mono<@NonNull DTO>> update(
        ...
        logger.debug("REST request to update related integration, parentId {}, childDomain {}, childCriteria {}", parentId, childDomain, childCriteria);
