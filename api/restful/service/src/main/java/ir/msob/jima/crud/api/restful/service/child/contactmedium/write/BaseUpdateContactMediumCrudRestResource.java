...
public interface BaseUpdateContactMediumCrudRestResource<
    ...
    default ResponseEntity<Mono<DTO>> update(@PathVariable("parentId") ID parentId, @RequestBody @Valid CM dto, C criteria, ServerWebExchange serverWebExchange, Principal principal) throws BadRequestException, DomainNotFoundException {
        log.debug("REST request to update contact medium, parentId {}, dto {}, criteria {}", parentId, dto, criteria);
