...
public interface BaseUpdateByKeyCharacteristicCrudRestResource<
    ...
    Logger logger = LoggerFactory.getLogger(BaseUpdateByKeyCharacteristicCrudRestResource.class);
    ...
    default ResponseEntity<@NonNull Mono<@NonNull DTO>> updateByKey(
        ...
        logger.debug("REST request to update characteristic, parentId {}, key {}, childDomain {}", parentId, key, childDomain);
