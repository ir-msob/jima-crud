...
public interface BaseDeleteByRelatedIdRelatedPartyCrudRestResource<
    ...
    Logger logger = LoggerFactory.getLogger(BaseDeleteByRelatedIdRelatedPartyCrudRestResource.class);
    ...
    default ResponseEntity<@NonNull Mono<@NonNull DTO>> deleteByRelatedId(
        ...
        logger.debug("REST request to delete related party by relatedId, parentId {}, relatedId {}", parentId, relatedId);
