...
public interface BaseUpdateRelatedPartyCrudRestResource<
    ...
    default ResponseEntity<Mono<DTO>> update(@PathVariable("parentId") ID parentId, @RequestBody @Valid RP dto, C criteria, ServerWebExchange serverWebExchange, Principal principal) throws BadRequestException, DomainNotFoundException {
        log.debug("REST request to update child party, parentId {}, dto {}, criteria {}", parentId, dto, criteria);
