...
public interface BaseUpdateByIdRelatedIntegrationCrudRestResource<
    ...
    default ResponseEntity<Mono<DTO>> updateById(@PathVariable("parentId") ID parentId, @PathVariable("id") ID id, @RequestBody @Valid RI dto, ServerWebExchange serverWebExchange, Principal principal) throws BadRequestException, DomainNotFoundException {
        log.debug("REST request to update related integration, parentId {}, id {}, dto {}", parentId, id, dto);
