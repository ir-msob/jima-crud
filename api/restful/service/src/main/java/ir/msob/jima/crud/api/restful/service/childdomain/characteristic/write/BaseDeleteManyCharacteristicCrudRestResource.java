...
public interface BaseDeleteManyCharacteristicCrudRestResource<
    ...
    Logger logger = LoggerFactory.getLogger(BaseDeleteManyCharacteristicCrudRestResource.class);
    ...
    default ResponseEntity<@NonNull Mono<@NonNull DTO>> deleteMany(
        ...
        logger.debug("REST request to delete multiple characteristics by criteria, parentId {}, criteria {}", parentId, childCriteria);
