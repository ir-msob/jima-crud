...
public interface BaseSaveManyRelatedActionCrudRestResource<
    ...
    default ResponseEntity<Mono<DTO>> saveMany(@PathVariable("parentId") ID parentId, @RequestBody Collection<@Valid OV> dtos, ServerWebExchange serverWebExchange, Principal principal) throws BadRequestException, DomainNotFoundException {
        log.debug("REST request to save many related-actions, parentId {}, dtos {}", parentId, dtos);
