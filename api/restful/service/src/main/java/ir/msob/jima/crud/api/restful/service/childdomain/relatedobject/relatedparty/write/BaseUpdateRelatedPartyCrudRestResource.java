...
public interface BaseUpdateRelatedPartyCrudRestResource<
    ...
    Logger logger = LoggerFactory.getLogger(BaseUpdateRelatedPartyCrudRestResource.class);
    ...
    default ResponseEntity<@NonNull Mono<@NonNull DTO>> update(
        ...
        logger.debug("REST request to update childdomain party, parentId {}, childDomain {}, childCriteria {}", parentId, childDomain, childCriteria);
