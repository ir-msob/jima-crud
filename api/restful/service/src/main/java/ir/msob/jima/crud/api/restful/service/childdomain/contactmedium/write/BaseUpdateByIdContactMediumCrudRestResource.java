...
public interface BaseUpdateByIdContactMediumCrudRestResource<
    ...
    Logger logger = LoggerFactory.getLogger(BaseUpdateByIdContactMediumCrudRestResource.class);
    ...
    default ResponseEntity<@NonNull Mono<@NonNull DTO>> updateById(
        ...
        logger.debug("REST request to update contact medium, parentId {}, id {}, childDomain {}", parentId, id, childDomain);
