...
public interface BaseDeleteByIdObjectValidationCrudRestResource<
    ...
    Logger logger = LoggerFactory.getLogger(BaseDeleteByIdObjectValidationCrudRestResource.class);
    ...
    default ResponseEntity<@NonNull Mono<@NonNull DTO>> deleteById(
        ...
        logger.debug("REST request to delete object-validation by id, parentId {}, id {}", parentId, id);
