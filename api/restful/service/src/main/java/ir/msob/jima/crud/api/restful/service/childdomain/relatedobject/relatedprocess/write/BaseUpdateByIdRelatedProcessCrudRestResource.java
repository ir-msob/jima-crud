...
public interface BaseUpdateByIdRelatedProcessCrudRestResource<
    ...
    Logger logger = LoggerFactory.getLogger(BaseUpdateByIdRelatedProcessCrudRestResource.class);
    ...
    default ResponseEntity<@NonNull Mono<@NonNull DTO>> updateById(
        ...
        logger.debug("REST request to update childdomain process, parentId {}, id {}, childDomain {}", parentId, id, childDomain);
