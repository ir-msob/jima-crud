package ir.msob.jima.crud.api.restful.service.related.relatedobject.relatedintegration;
...
public interface BaseUpdateManyRelatedIntegrationCrudRestResource<
    ...
    Logger log = LoggerFactory.getLogger(BaseUpdateManyRelatedIntegrationCrudRestResource.class);


    @PutMapping("{parentId}/related-integration/" + Operations.UPDATE_MANY)
    @ApiResponses(value = {
    ...
    default ResponseEntity<Mono<DTO>> updateMany(@PathVariable("parentId") ID parentId, @RequestBody Collection<@Valid RI> dtos, ServerWebExchange serverWebExchange, Principal principal) throws BadRequestException, DomainNotFoundException {
        log.debug("REST request to update related integration, parentId {}, dtos {}", parentId, dtos);
