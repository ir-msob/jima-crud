...
public interface BaseSaveRelatedIntegrationCrudRestResource<
    ...
    default ResponseEntity<Mono<DTO>> save(@PathVariable("parentId") ID parentId, @RequestBody @Valid RI dto, ServerWebExchange serverWebExchange, Principal principal) throws BadRequestException, DomainNotFoundException {
        log.debug("REST request to save related integration, parentId {}, dto {}", parentId, dto);
