...
public interface BaseUpdateByRelatedIdRelatedPartyCrudRestResource<
    ...
    Logger logger = LoggerFactory.getLogger(BaseUpdateByRelatedIdRelatedPartyCrudRestResource.class);
    ...
    default ResponseEntity<@NonNull Mono<@NonNull DTO>> updateByRelatedId(
        ...
        logger.debug("REST request to update childdomain party, parentId {}, relatedId {}, childDomain {}", parentId, relatedId, childDomain);
