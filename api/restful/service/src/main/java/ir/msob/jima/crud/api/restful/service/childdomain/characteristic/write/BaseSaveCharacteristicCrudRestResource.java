...
public interface BaseSaveCharacteristicCrudRestResource<
    ...
    Logger logger = LoggerFactory.getLogger(BaseSaveCharacteristicCrudRestResource.class);
    ...
    @MethodStats
    @Scope(element = Elements.CHARACTERISTIC, operation = Operations.SAVE)
    default ResponseEntity<@NonNull Mono<@NonNull DTO>> save(
        ...
        logger.debug("REST request to save characteristic, parentId {}, childDomain {}", parentId, childDomain);
