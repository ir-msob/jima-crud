...
public interface BaseDeleteByRelatedIdRelatedIntegrationCrudRestResource<
    ...
    Logger logger = LoggerFactory.getLogger(BaseDeleteByRelatedIdRelatedIntegrationCrudRestResource.class);
    ...
    @MethodStats
    @Scope(element = Elements.RELATED_INTEGRATION, operation = Operations.DELETE_BY_RELATED_ID)
    default ResponseEntity<@NonNull Mono<@NonNull DTO>> deleteByRelatedId(
        ...
        logger.debug("REST request to delete related integration by relatedId, parentId {}, relatedId {}", parentId, relatedId);
