...
public interface BaseGetManyCrudListener<
    ...
    Logger log = LoggerFactory.getLogger(BaseGetManyCrudListener.class);

    @PostConstruct
    default void getMany() throws InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
        ...
        containerProperties.setMessageListener((MessageListener<String, String>) dto -> serviceGetMany(dto.value()));
