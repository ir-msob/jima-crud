...
public interface BaseCountCrudListener<
    ...
    Logger log = LoggerFactory.getLogger(BaseCountCrudListener.class);

    @PostConstruct
    default void count() throws InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
