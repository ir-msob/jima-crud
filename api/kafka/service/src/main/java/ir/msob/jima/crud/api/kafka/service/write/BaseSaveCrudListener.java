...
public interface BaseSaveCrudListener<
    ...
    Logger log = LoggerFactory.getLogger(BaseSaveCrudListener.class);

    @PostConstruct
    default void save() throws InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
