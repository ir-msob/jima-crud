...
public interface BaseDeleteCrudListener<
    ...
    Logger log = LoggerFactory.getLogger(BaseDeleteCrudListener.class);

    @PostConstruct
    default void delete() throws InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
