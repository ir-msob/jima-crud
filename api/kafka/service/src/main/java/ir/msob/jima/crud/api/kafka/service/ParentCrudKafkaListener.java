 ...
 */
public interface ParentCrudKafkaListener<
    ...
    default Class<D> getDomainClass() {
        return (Class<D>) GenericTypeUtil.resolveTypeArguments(this.getClass(), ParentCrudKafkaListener.class, 2);
    }
    ...
    default Class<DTO> getDtoClass() {
        return (Class<DTO>) GenericTypeUtil.resolveTypeArguments(getClass(), ParentCrudKafkaListener.class, 3);
    }
    ...
    default Class<C> getCriteriaClass() {
        return (Class<C>) GenericTypeUtil.resolveTypeArguments(getClass(), ParentCrudKafkaListener.class, 4);
    }
    ...
    default Class<R> getRepositoryClass() {
        return (Class<R>) GenericTypeUtil.resolveTypeArguments(this.getClass(), ParentCrudKafkaListener.class, 5);
    }
