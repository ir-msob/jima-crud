 ...
 * It extends both the {@code BaseDeleteManyDomainCrudResourceTest} and {@code ParentDomainCrudKafkaListenerTest} interfaces, providing RESTful-specific testing capabilities.
 * <p>
...
public interface BaseDeleteManyDomainCrudKafkaListenerTest<
    ...
    default void deleteManyRequest(DTO savedDto, Assertable<Set<ID>> assertable) throws DomainNotFoundException, BadRequestException {
        ...
        startListener(channelMessage.getCallbacks().getFirst().getChannel(), s -> assertable.assertThan(new HashSet<>(cast(s, getIdsReferenceType()).getData().getIds())));
