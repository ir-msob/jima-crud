 ...
 * It extends the ParentDomainCrudRsocketResource interface and provides a default implementation for the edit method.
 *
 ...
 * @author Yaqub Abdi
 */
public interface BaseEditDomainCrudRsocketResource<
    ...
    Logger logger = LoggerFactory.getLogger(BaseEditDomainCrudRsocketResource.class);
    ...
    default Mono<@NonNull DTO> edit(@Payload String dto, @AuthenticationPrincipal Jwt principal)
            throws BadRequestException, DomainNotFoundException, JsonProcessingException {
        logger.debug("RSocket request to edit new domain, dto : {}", dto);
