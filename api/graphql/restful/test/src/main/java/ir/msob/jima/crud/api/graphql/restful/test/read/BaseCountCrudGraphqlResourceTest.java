...
/**
 * The {@code BaseCountCrudGraphqlResourceTest} interface represents a set of GraphQL-specific test methods
 ...
 */
public interface BaseCountCrudGraphqlResourceTest<
