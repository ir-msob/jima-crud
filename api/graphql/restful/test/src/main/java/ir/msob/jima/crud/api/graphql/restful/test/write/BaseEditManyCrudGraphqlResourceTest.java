...
/**
 * The {@code BaseEditManyCrudGraphqlResourceTest} interface represents a set of GraphQL-specific test methods
 * for editing (updating) multiple entities based on criteria using JSON Patch operations. It extends both the
 * {@code BaseEditManyCrudResourceTest} and {@code ParentCrudGraphqlResourceTest} interfaces, providing GraphQL-specific
 ...
 */
public interface BaseEditManyCrudGraphqlResourceTest<
     ...
     * @return A collection of data transfer objects (DTOs) representing the edited entities.
     */
    @Override
