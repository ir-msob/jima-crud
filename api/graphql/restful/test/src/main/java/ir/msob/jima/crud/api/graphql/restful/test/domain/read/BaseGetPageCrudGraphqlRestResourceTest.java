...
/**
 * The {@code BaseGetPageCrudGraphqlRestResourceTest} interface represents a set of GraphQL-specific test methods
 * for retrieving a page of entities based on criteria in the context of CRUD operations. It extends both the
 * {@code BaseGetPageCrudResourceTest} and {@code ParentCrudGraphqlRestResourceTest} interfaces, providing GraphQL-specific
 ...
 * @see ParentCrudGraphqlRestResourceTest
 */
public interface BaseGetPageCrudGraphqlRestResourceTest<
