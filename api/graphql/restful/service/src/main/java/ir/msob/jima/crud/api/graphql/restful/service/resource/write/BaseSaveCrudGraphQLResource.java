...
/**
 * The {@code BaseSaveCrudGraphQLResource} interface defines a GraphQL mutation for saving a single entity.
 * It extends the {@code BaseCrudGraphQL} interface and provides a method for saving an entity with the specified DTO input.
 ...
 * @see BaseCrudGraphQL
 */
public interface BaseSaveCrudGraphQLResource<
    ...
    Logger log = LoggerFactory.getLogger(BaseSaveCrudGraphQLResource.class);
    ...
    default Mono<DtoType> save(@Argument DtoInput input, @ContextValue(value = HttpHeaders.AUTHORIZATION, required = false) String token) throws BadRequestException, DomainNotFoundException {
