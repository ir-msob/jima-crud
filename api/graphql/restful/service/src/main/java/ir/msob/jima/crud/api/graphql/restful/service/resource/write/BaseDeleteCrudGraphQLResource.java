...
/**
 * The {@code BaseDeleteCrudGraphQLResource} interface defines a GraphQL mutation for deleting entities
 * based on specified criteria. It extends the {@code BaseCrudGraphQL} interface and provides a method
 ...
 * @see BaseCrudGraphQL
 */
public interface BaseDeleteCrudGraphQLResource<
    ...
    Logger log = LoggerFactory.getLogger(BaseDeleteCrudGraphQLResource.class);
    ...
    @MethodStats
    @MutationMapping
    default Mono<IdType> delete(@Argument CriteriaInput input, @ContextValue(value = HttpHeaders.AUTHORIZATION, required = false) String token) throws BadRequestException, DomainNotFoundException {
