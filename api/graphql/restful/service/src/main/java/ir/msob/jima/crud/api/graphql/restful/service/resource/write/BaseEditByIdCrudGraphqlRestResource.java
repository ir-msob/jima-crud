...
/**
 * The {@code BaseEditCrudGraphqlRestResource} interface defines a GraphQL mutation for editing an entity based on JSON Patch
 * operations. It extends the {@code ParentCrudGraphqlRestResource} interface and provides a method for editing an entity with optional
 ...
 */
public interface BaseEditByIdCrudGraphqlRestResource<
    ...
    Logger log = LoggerFactory.getLogger(BaseEditByIdCrudGraphqlRestResource.class);
