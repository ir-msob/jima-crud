 ...
 * JSON Patch operations. It extends the {@code ParentCrudGraphqlRestResource} interface and provides a method for editing multiple entities
 ...
 */
public interface BaseEditManyCrudGraphqlRestResource<
    ...
    Logger log = LoggerFactory.getLogger(BaseEditManyCrudGraphqlRestResource.class);
