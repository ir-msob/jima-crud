...
/**
 * The {@code BaseSaveManyCrudGraphQLResource} interface defines a GraphQL mutation for saving multiple entities.
 * It extends the {@code BaseCrudGraphQL} interface and provides a method for saving multiple entities with the specified DTOs input.
...
public interface BaseSaveManyCrudGraphQLResource<
    ...
    Logger log = LoggerFactory.getLogger(BaseSaveManyCrudGraphQLResource.class);
    ...
    default Mono<DtosType> saveMany(@Argument DtosInput input, @ContextValue(value = HttpHeaders.AUTHORIZATION, required = false) String token) throws BadRequestException, DomainNotFoundException {
