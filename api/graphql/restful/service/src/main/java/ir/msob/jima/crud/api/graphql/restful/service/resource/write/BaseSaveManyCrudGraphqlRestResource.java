...
/**
 * The {@code BaseSaveManyCrudGraphqlRestResource} interface defines a GraphQL mutation for saving multiple entities.
 * It extends the {@code ParentCrudGraphqlRestResource} interface and provides a method for saving multiple entities with the specified DTOs input.
 ...
 */
public interface BaseSaveManyCrudGraphqlRestResource<
    ...
    Logger log = LoggerFactory.getLogger(BaseSaveManyCrudGraphqlRestResource.class);
