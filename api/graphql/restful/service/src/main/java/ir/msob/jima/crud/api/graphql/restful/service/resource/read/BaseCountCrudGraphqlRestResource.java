...
/**
 * The {@code BaseCountCrudGraphqlRestResource} interface defines GraphQL queries for counting entities based on specified criteria.
 * It extends the {@code ParentCrudGraphqlRestResource} interface and provides a method for counting entities with optional criteria input.
 ...
 */
public interface BaseCountCrudGraphqlRestResource<
    ...
    Logger log = LoggerFactory.getLogger(BaseCountCrudGraphqlRestResource.class);
