...
/**
 * The {@code BaseGetOneCrudGraphQLResource} interface defines a GraphQL query for retrieving a single entity
 ...
 * @see BaseCrudGraphQL
 */
public interface BaseGetOneCrudGraphQLResource<
    ...
    Logger log = LoggerFactory.getLogger(BaseGetOneCrudGraphQLResource.class);
