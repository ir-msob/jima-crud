...
/**
 * The {@code BaseCountDomainCrudGraphqlRestResource} interface defines GraphQL queries for counting entities based on specified criteria.
 * It extends the {@code ParentDomainCrudGraphqlRestResource} interface and provides a method for counting entities with optional criteria input.
 ...
 */
public interface BaseCountDomainCrudGraphqlRestResource<
    ...
    Logger logger = LoggerFactory.getLogger(BaseCountDomainCrudGraphqlRestResource.class);
    ...
    default Mono<@NonNull CountType> count(@Argument("input") CriteriaInput input, @ContextValue(value = HttpHeaders.AUTHORIZATION, required = false) String token) throws BadRequestException, DomainNotFoundException {
        logger.debug("Request to count: dto {}", input);
