...
public interface BaseEditDomainCrudGraphqlRestResource<
    ...
    Logger logger = LoggerFactory.getLogger(BaseEditDomainCrudGraphqlRestResource.class);
    ...
    default Mono<@NonNull DtoType> edit(@Argument("input") CriteriaJsonPatchInput input, @ContextValue(value = HttpHeaders.AUTHORIZATION, required = false) String token) throws BadRequestException, DomainNotFoundException {
        logger.debug("Request to edit: dto {}", input);
