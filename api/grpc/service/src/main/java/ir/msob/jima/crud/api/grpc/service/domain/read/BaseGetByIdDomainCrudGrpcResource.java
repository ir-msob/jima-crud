 ...
 */
public interface BaseGetByIdDomainCrudGrpcResource<
    ...
    Logger logger = LoggerFactory.getLogger(BaseGetByIdDomainCrudGrpcResource.class);


    @MethodStats
    @Scope(operation = Operations.GET_BY_ID)
    @Override
    default void getById(IdMsg request, StreamObserver<DtoMsg> responseObserver) {
        logger.debug("Request to get by id: dto {}", request);
        getService().getOne(convertToId(request.getId()), getUser())
