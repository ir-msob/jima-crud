...
import ir.msob.jima.crud.api.grpc.service.domain.base.CrudGrpcResource;
...
public class TestDomainGrpcResource extends CrudGrpcResource<TestDomain, TestDto, TestCriteria, TestRepository, TestService> {
    ...
    public TestDomainGrpcResource(ObjectMapper objectMapper, ProjectUserService projectUserService, TestService service) {
