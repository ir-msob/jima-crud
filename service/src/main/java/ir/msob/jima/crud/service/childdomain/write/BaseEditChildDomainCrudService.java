 ...
 */
public interface BaseEditChildDomainCrudService<ID extends Comparable<ID> & Serializable, USER extends BaseUser, D extends BaseChildDomain<ID>, DTO extends BaseChildDto<ID>, C extends BaseChildCriteria<ID>, R extends BaseDomainCrudRepository<ID, D, C>> extends ParentWriteChildDomainCrudService<ID, USER, D, DTO, C, R> {
    Logger logger = LoggerFactory.getLogger(BaseEditChildDomainCrudService.class);
    ...
    @Transactional
    @MethodStats
    default Mono<@NonNull DTO> edit(ID parentId, ID id, JsonPatch jsonPatch, USER user) throws BadRequestException, DomainNotFoundException {
    ...
    @Transactional
    @MethodStats
    default Mono<@NonNull DTO> edit(ID parentId, C criteria, JsonPatch jsonPatch, USER user) throws BadRequestException, DomainNotFoundException {
