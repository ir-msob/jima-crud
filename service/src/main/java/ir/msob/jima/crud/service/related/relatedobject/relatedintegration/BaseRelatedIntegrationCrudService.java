...
public interface BaseRelatedIntegrationCrudService<
        ...
        , C extends RelatedIntegrationCriteriaAbstract<ID>
        , RI extends RelatedIntegrationAbstract<ID>>
        extends ParentRelatedObjectService<ID, String, USER, DTO, C, RI, BaseRelatedIntegrationDto<ID, RI>> {
    ...
    @Transactional
    @MethodStats
    default Mono<DTO> saveMany(@NotNull ID parentId, List<RI> relatedIntegrations, USER user) throws DomainNotFoundException, BadRequestException {
        return saveMany(
                parentId
                , relatedIntegrations
                , dto -> ((BaseRelatedIntegrationDto<ID, RI>) dto).getRelatedIntegrations()
    ...
    @Transactional
    @MethodStats
    default Mono<DTO> updateMany(@NotNull ID parentId, List<RI> relatedIntegrations, USER user) throws DomainNotFoundException, BadRequestException {
        return updateMany(
                parentId
                , relatedIntegrations
                , dto -> ((BaseRelatedIntegrationDto<ID, RI>) dto).getRelatedIntegrations()
