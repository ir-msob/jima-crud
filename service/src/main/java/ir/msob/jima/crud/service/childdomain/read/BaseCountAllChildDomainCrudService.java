 ...
 */
public interface BaseCountAllChildDomainCrudService<ID extends Comparable<ID> & Serializable, USER extends BaseUser,
        D extends BaseChildDomain<ID>, DTO extends BaseChildDto<ID>,
        C extends BaseChildCriteria<ID>,
        R extends BaseDomainCrudRepository<ID, D, C>>
        extends ParentReadChildDomainCrudService<ID, USER, D, DTO, C, R> {

    Logger logger = LoggerFactory.getLogger(BaseCountAllChildDomainCrudService.class);
    ...
    @MethodStats
    default Mono<@NonNull Long> countAll(ID parentId, @NotNull USER user) {
